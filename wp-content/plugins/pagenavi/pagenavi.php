...
Description: Adds a more advanced paging navigation to your WordPress blog. Modified by John Havlik for Cran-Berry
Version: 9999
			...
			switch(intval($pagenavi_options['style'])) {
				case 1:
					...
					if ($end_page < $max_page)
					{
						...
						echo '<a href="'.get_pagenum_link(($max_page - 1)).'" title="'.($max_page - 1).'">'.($max_page - 1).'</a>';
						echo '<a href="'.get_pagenum_link($max_page).'" title="'.str_replace("%LAST_PAGE%", $max_page, $pagenavi_options['last_text']).'">'.str_replace("%LAST_PAGE%", $max_page, $pagenavi_options['last_text']).'</a>';
					}
